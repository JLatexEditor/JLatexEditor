 ...
 * @author Jeff Dinkins
 */
public class SCEFileChooserUI extends BasicFileChooserUI {
    ...
    public static ComponentUI createUI(JComponent c) {
        return new SCEFileChooserUI((JFileChooser) c);
    }

    public SCEFileChooserUI(JFileChooser filechooser) {
	    super(filechooser);
    }
  ...
  private class SCEFileChooserUIAccessor implements SCEFilePane.FileChooserUIAccessor {
	public JFileChooser getFileChooser() {
	    return SCEFileChooserUI.this.getFileChooser();
	}

	public BasicDirectoryModel getModel() {
	    return SCEFileChooserUI.this.getModel();
	}

	public JPanel createList() {
	    return SCEFileChooserUI.this.createList(getFileChooser());
	}

	public JPanel createDetailsView() {
	    return SCEFileChooserUI.this.createDetailsView(getFileChooser());
	}

	public boolean isDirectorySelected() {
	    return SCEFileChooserUI.this.isDirectorySelected();
	}

	public File getDirectory() {
	    return SCEFileChooserUI.this.getDirectory();
	}

	public Action getChangeToParentDirectoryAction() {
	    return SCEFileChooserUI.this.getChangeToParentDirectoryAction();
	}

	public Action getApproveSelectionAction() {
	    return SCEFileChooserUI.this.getApproveSelectionAction();
	}

	public Action getNewFolderAction() {
	    return SCEFileChooserUI.this.getNewFolderAction();
	}

	public MouseListener createDoubleClickListener(JList list) {
	    return SCEFileChooserUI.this.createDoubleClickListener(getFileChooser(),
								     list);
	}

	public ListSelectionListener createListSelectionListener() {
	    return SCEFileChooserUI.this.createListSelectionListener(getFileChooser());
	}
	...
	filePane = new SCEFilePane(new SCEFileChooserUIAccessor());
	...
	listViewButton.addActionListener(filePane.getViewTypeAction(SCEFilePane.VIEWTYPE_LIST));
	...
	detailsViewButton.addActionListener(filePane.getViewTypeAction(SCEFilePane.VIEWTYPE_DETAILS));
	...
	filePane.addPropertyChangeListener(new PropertyChangeListener() {
		...
		if ("viewType".equals(e.getPropertyName())) {
		    ...
		    switch (viewType) {
		      case SCEFilePane.VIEWTYPE_LIST:
			listViewButton.setSelected(true);
			break;

		      case SCEFilePane.VIEWTYPE_DETAILS:
	...
	SCEFilePane.addActionsToMap(map, filePane.getActions());
        return map;
    }

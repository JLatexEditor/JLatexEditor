 ...
 */
public class SCEFilePane extends JPanel implements PropertyChangeListener {
                ...
                if (f != null) {
                    ...
                    if (!newDisplayName.equals(oldDisplayName)) {
                        ...
                        if (f2.exists()) {
                            ...
                            if (SCEFilePane.this.getModel().renameFile(f, f2)) {
    ...
    private class DetailsTableRowSorter extends TableRowSorter<TableModel> {
        ...
        private class SorterModelWrapper extends ModelWrapper<TableModel, Integer> {
            ...
            public Object getValueAt(int row, int column) {
                return SCEFilePane.this.getModel().getElementAt(row);
            }
    ...
    public Action getNewFolderAction() {
        if (!readOnly && newFolderAction == null) {
            newFolderAction = new AbstractAction(newFolderActionLabelText) {
                ...
                // Initializer
                {
                    putValue(Action.ACTION_COMMAND_KEY, SCEFilePane.ACTION_NEW_FOLDER);
